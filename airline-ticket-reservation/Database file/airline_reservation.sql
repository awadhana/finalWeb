...
ALTER TABLE payment_details
  ADD card_name varchar(30) DEFAULT NULL;

  ALTER TABLE payment_details
    ADD card_number varchar(30) DEFAULT NULL;

  ALTER TABLE payment_details
      ADD billing_address varchar(255) DEFAULT NULL;

  ALTER TABLE payment_details
        ADD phone_number varchar(11) DEFAULT NULL;

-- ALTER TABLE payment_details
--         ADD card_type varchar(30) DEFAULT NULL;
...
ALTER TABLE payment_details
      ADD security_code varchar(5) DEFAULT NULL;

      -- ALTER TABLE payment_details
      --       ADD Expiration varchar(5) DEFAULT NULL;
