...
CREATE TABLE `flight_details` (
  ...
  `spots_VIP` int(5) DEFAULT NULL,
  `price_regular` int(10) DEFAULT NULL,
  `price_VIP` int(10) DEFAULT NULL,
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `parking_details` (`spot_no`, 'departure_date`, `arrival_date`, `spots_regular`, `spots_VIP`, `price_regular`, `price_VIP`) VALUES
('AA101', 195, 96, 5000, 7500, '10001'),
('AA102', 200, 73, 2500, 3000, '10002'),
('AA103', 150, 75, 1200, 1500, '10004'),
('AA104', 37, 4, 500, 750, '10003'),
('AA106', 150, 75, 3000, 3750, '10004');
