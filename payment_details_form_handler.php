			...
			if(isset($_POST['Pay_Now']))
			{
				...
				*/
				if($affected_rows_1==1)
				{
					...
					$query="INSERT INTO Payment_Details (payment_id,pnr,payment_date,payment_amount,payment_mode,card_name,card_number) VALUES (?,?,?,?,?,?,?)";
					$stmt=mysqli_prepare($dbc,$query);
					mysqli_stmt_bind_param($stmt,"sssisss",$payment_id,$pnr,$payment_date,$total_amount,$payment_mode,$card_name,$card_number);
					mysqli_stmt_execute($stmt);
